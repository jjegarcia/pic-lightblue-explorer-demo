...
#define SERVICE_LED_STATE_REQUEST_SetHigh()                            (SERVICE.LED_STATE_REQUEST = 1)
#define SERVICE_LED_STATE_REQUEST_SetLow()                             (SERVICE.LED_STATE_REQUEST = 0)
#define SERVICE_LED_STATE_REQUEST_Toggle()                             (SERVICE.LED_STATE_REQUEST = ~SERVICE.LED_STATE_REQUEST)
#define SERVICE_LED_STATE_REQUEST_GetValue()                           (SERVICE.LED_STATE_REQUEST)
#define SERVICE_LED_STATE_REQUEST_Is_High()                            (SERVICE.LED_STATE_REQUEST == 1)
